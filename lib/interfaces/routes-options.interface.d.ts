...
export declare type GetMayRouteOptions = BaseRouteOptions;
export declare type GetOneRouteOptions = BaseRouteOptions;
export interface CreateOneRouteOptions extends BaseRouteOptions {
    returnShallow?: boolean;
}
export declare type CreateManyRouteOptions = BaseRouteOptions;
